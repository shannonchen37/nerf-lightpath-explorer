"""Build d3.1 traces and validate attribution/UI consistency without rerendering."""
...
from reimpl.d3_causal_explorer.schema import build_pixel_trace, lum, mul

ROOT = Path.home() / "nerf_inverse_rendering"
RAW = ROOT / "results/d2_pixel_inspector/traces"
OUT = ROOT / "results/d3_causal_explorer"
GMM = ROOT / "results/d1_official_demo/gmm_components.json"
