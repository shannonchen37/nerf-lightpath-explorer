...
from reimpl.hybrid_teapot.hybrid_renderer import HybridTeapotRender
from reimpl.hybrid_teapot.segment_query import query_environment_segment
...
def render_principled_teapot(
    ...
    chunk_size: int = 16384, official_camera_vacuum: bool = True,
    ...
    metrics = {
        ...
        "bsdf_mode": "official_mitsuba_principled", "specular": float(getattr(bsdf, "specular", 1.0)),
        "camera_segment_mode": "mitsuba_vacuum" if official_camera_vacuum else "h4_finite_nerf_segment",
