...
D1 = ROOT / "results/d1_official_demo"; D2 = ROOT / "results/d2_pixel_inspector/traces"
OUT = ROOT / "results/d3_causal_explorer/interventions"
...
def main():
    ...
    raw=json.loads((D2/f"pixel_{pixel[0]}_{pixel[1]}.json").read_text()); OUT.mkdir(parents=True,exist_ok=True)
