"""Compare cosine, BSDF, spatial-vMF, and one-sample MIS strategies."""
...
from nerf_lightpath_explorer.pbir.demo_renderer import center_camera_rays,render_center
...
OUT=RESULTS_ROOT/"demo"; AB=OUT/"sampling_ab"; RES=128
...
def main() -> None:
    ...
    subprocess.run([sys.executable,str(ROOT/"src/nerf_lightpath_explorer/build_uv_correspondence.py"),str(oracle_in),str(oracle_out),str(ASSETS/"mesh.obj")],check=True)
