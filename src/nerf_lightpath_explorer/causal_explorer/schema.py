"""Stable trace schema and exact attribution derived from saved renderer paths."""
...
def build_pixel_trace(raw: dict, gmm: dict) -> dict:
    ...
    why = {
        ...
        "shading_regime": regime, "material": "Recovered Principled material" if raw["material"] else None,
    ...
    return {
        "schema_version": SCHEMA_VERSION, "trace_semantics": "EXACT saved renderer paths and Gaussian reconstruction",
        "diagnostic_boundary": "NeRF volume samples are a diagnostic single-ray retrace, not stored final-render internal samples",
        ...
        "nerf_diagnostic": {**raw["nerf_selected_ray"], "display_label": "DIAGNOSTIC NeRF RETRACE — not stored final-render volume sequence",
