"""Validate the Mitsuba camera and one-sample-MIS integrator without NeRF."""
...
from nerf_lightpath_explorer.tests._common import load_emitter
...
def main() -> None:
    ...
    from nerf_lightpath_explorer.runtime_paths import ASSET_ROOT
    assets = ASSET_ROOT
    scene = mi.load_dict({
        "type":"scene",
    ...
    result={"status":"PASS", "integrator":"sdf_direct_reparam_onesamplemis", "emitter":"constant",
            "sensor":"expected camera 0", "resolution":[64,64], "spp":1,
