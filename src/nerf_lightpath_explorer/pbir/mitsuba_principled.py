"""Mitsuba-compatible Mitsuba principled BSDF evaluation for explicit surfaces.
...
class MitsubaPrincipledTextureBSDF:
    """Mitsuba texture-backed Principled BSDF evaluated in batches."""
    ...
    def sample(self,normal:torch.Tensor,wo:torch.Tensor,uv:torch.Tensor,
        ...
        """Sample the installed Mitsuba-compatible plugin; return world wi/pdf/delta."""
        import drjit as dr
...
class MitsubaPrincipledConstantBSDF:
    """Mitsuba-compatible principled mode for constant opaque material presets."""
...
class MitsubaPrincipledInterventionBSDF(MitsubaPrincipledTextureBSDF):
    """Mitsuba-compatible principled plugin with causal material overrides."""
