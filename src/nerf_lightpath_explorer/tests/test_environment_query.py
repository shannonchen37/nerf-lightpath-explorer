"""Full/environment queries must switch density state and restore it exactly."""

import torch

from nerf_lightpath_explorer.pbir.aabb_control import aabb_disable_state, set_aabb_disabled
from nerf_lightpath_explorer.pbir.environment_query import EnvironmentNerfQuery
from nerf_lightpath_explorer.tests._common import deterministic_rays, load_emitter
