"""Acceptance checks for the four required pixel-trace classes."""
...
def main() -> None:
    ...
    result={"status":status,"classes":checks,"viewer":"run_explorer.py","trace_json_export":True,
            "exact_trace":"same primary/path seeds, stored Li/contributions, and Gaussian reconstruction",
